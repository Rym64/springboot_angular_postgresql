...
@Component({
  selector: 'app-rechercher-appel-offre',
  templateUrl: './rechercher-appel-offre.component.html',
  styleUrls: ['./rechercher-appel-offre.component.css']
})



export class RechercherAppelOffreComponent implements OnInit {
  ...
  getData(): void {
    ...
    this.webService.rechercher("rechercherAppelOffre",this.recherche).subscribe(res => {
      let response = JSON.parse(JSON.stringify(res))
      this.appelsOffreList = response })
  }
 ...
 return {
  ...
  afficherDetails(appelOffre){
   ...
   updateAppelOffre(appelOffre){  
    this.webService.setterAppelOffre(appelOffre);
    this.router.navigate(['modifierAppelOffre']);
  }

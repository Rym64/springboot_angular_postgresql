...
@Component({
  selector: 'app-rechercher-marche',
  templateUrl: './rechercher-marche.component.html',
  styleUrls: ['./rechercher-marche.component.css']
})



export class RechercherMarcheComponent implements OnInit {
  ...
  getData(): void {
    ...
    this.webService.rechercher("rechercherMarche",this.recherche).subscribe(res => {
...
getList(marche : Array<Marche>){
 return {
  ...
  deleteMarche(marche: Marche): void {
   ...
   updateMarche(marche){  
    this.webService.setterMarche(marche);
    this.router.navigate(['modifierMarche']);
  }

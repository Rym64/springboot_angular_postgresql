...
@Component({
  selector: 'app-rechercher-lot-appel-offre',
  templateUrl: './rechercher-lot-appel-offre.component.html',
  styleUrls: ['./rechercher-lot-appel-offre.component.css']
})



export class RechercherLotAppelOffreComponent implements OnInit {
  ...
  getData(): void {
    ...
    this.webService.rechercher("rechercherLotAppelOffre",this.recherche).subscribe(res => {
      let response = JSON.parse(JSON.stringify(res))
      this.lotsAppelOffreList = response})
  }
 ...
 return {
  ...
  rechercherLotAppelOffre(recherche){
   ...
   updateLotAppelOffre(lotAppelOffre){  
    this.webService.setterLotAppelOffre(lotAppelOffre);
    this.router.navigate(['modifierLotAppelOffre']);
  }

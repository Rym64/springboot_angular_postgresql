...
@Component({
  selector: 'app-rechercher-indicateur',
  templateUrl: './rechercher-indicateur.component.html',
  styleUrls: ['./rechercher-indicateur.component.css']
})



export class RechercherIndicateurComponent implements OnInit {
  ...
  getData(): void {
    ...
    this.webService.rechercher("rechercherIndicateur",this.recherche).subscribe(res => {
      let response = JSON.parse(JSON.stringify(res))
      this.indicateursList = response})
}

...
import { ModifierObjectifComponent } from '../modifier objectif/modifier-objectif.component';
...
@Component({
  selector: 'app-afficher-objectifs',
  templateUrl: './afficher-objectifs.component.html',
  styleUrls: ['./afficher-objectifs.component.css']
})



export class AfficherObjectifsComponent implements OnInit {
    ...
    getData(): void {
      this.webService.get("afficherObjectifs").subscribe(res => {
        let response = JSON.parse(JSON.stringify(res))
        this.objectifsList = response.data})
    }
    ...
    getCurrentUser(): void {
     ...
     updateObjectif(objectif){  
      this.webService.setterObjectif(objectif);
      this.dialog.open(ModifierObjectifComponent);
    }

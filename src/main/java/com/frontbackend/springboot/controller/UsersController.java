...
import com.frontbackend.springboot.service.UserService;
...
public class UsersController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<User> post(@PathVariable String id) {
	...
	@GetMapping
    public List<User> list(@RequestParam(required = false) String firstname) {

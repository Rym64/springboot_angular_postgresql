...
export class AdminPageComponent implements OnInit {
  ...
  userProfilProjet: UserProfilProjet = new UserProfilProjet()
  ...
  getData(): void {
    this.webService.get("projetsProfilsParUtilisateur").subscribe(res => {
      ...
      content: [
        {
          ...
          columns: [
            [{
              text: ' قائمة مهام المستخدمين حسب المشاريع ',
              alignment: 'center',
              color: 'green',
              fontSize: 20,
              font: 'mykuffi'
